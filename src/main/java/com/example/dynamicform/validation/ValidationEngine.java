package com.example.dynamicform.validation;
...
public interface ValidationEngine {
     ...
     */
    List<ValidationError> validateField(String fieldName, Object value, List<com.example.dynamicform.dto.ValidationDefinition> validations);
}
