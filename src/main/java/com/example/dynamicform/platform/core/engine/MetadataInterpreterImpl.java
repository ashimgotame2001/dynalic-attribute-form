...
import com.example.dynamicform.platform.api.exception.MetadataInterpretationException;
...
public class MetadataInterpreterImpl implements MetadataInterpreter {
    ...
    private FieldDefinition interpretAttribute(RawDomainAttribute raw) {
        ...
        return FieldDefinition.builder()
                ...
                .shortLabelI18n(raw.getShortLabelI18n())
                .longLabel(raw.getLongLabel())
                .longLabelI18n(raw.getLongLabelI18n())
                .dataType(modelName)
