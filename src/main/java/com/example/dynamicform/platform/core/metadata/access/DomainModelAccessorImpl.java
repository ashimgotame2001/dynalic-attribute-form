...
import com.example.dynamicform.platform.core.compatibility.BackwardCompatibilityService;
...
import com.example.dynamicform.platform.core.validation.DomainIntegrityValidationService;
...
public class DomainModelAccessorImpl implements DomainModelAccessor<Map<String, Object>> {
    ...
    public List<Map<String, Object>> getRelated(String entityId, String relationshipName) {
        ...
        Optional<com.example.dynamicform.platform.api.dto.RelationshipDefinitionDTO> definition =
