...
public class RSPWiseDocumentFieldConfigEntity {
    ...
    private RSPWiseDocumentSetupEntity setup;
    ...
    private Set<RSPWiseDocumentFieldValidationEntity> validations = new LinkedHashSet<>();

    @Builder.Default
    @OneToMany(mappedBy = "fieldConfig", cascade = CascadeType.ALL, orphanRemoval = true)
    @OrderBy("locale ASC")
    private Set<RSPWiseDocumentFieldTranslationEntity> translations = new LinkedHashSet<>();
